...
//export const rpc = new JsonRpc("https://telos.eosphere.io");
export const rpc = new JsonRpc("https://api.telos.africa");
//export const rpc = new JsonRpc("https://telos.caleos.io");

export const xrpc = new JsonRpc("https://eos.greymass.com");
