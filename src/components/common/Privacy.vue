    ...
    <div class="content d-flex flex-column align-items-start">
      ...
      <div class="wrapper">
        ...
        <p>
          ...
          <a :href="website" class="orange" target="_blank">telosd.com</a>, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by Telos Swaps and how we use it.
        </p>
        <p>
        ...
        <p>
          Telos Swaps legal basis for collecting and using the personal information
        ...
        <ul>
          ...
          <li>
            Processing your personal information is in Telos Swaps legitimate
            interests
          </li>
          <li>Telos Swaps needs to comply with the law</li>
        </ul>
        <p>
          Telos Swaps will retain your personal information only for as long as is
        ...
        <h2>Log Files</h2>
        <p>
          Telos Swaps follows a standard procedure of using log files. These files
        ...
        <p>
          Like any other website, Telos Swaps uses ‘cookies’. These cookies are used
        ...
        <p>
          ...
          advertising partners of Telos Swaps.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Telos Swaps, which are sent
        ...
        <p>
          Note that Telos Swaps has no access to or control over these cookies that
          are used by third-party advertisers.
        </p>
        <h2>THIRD PARTY PRIVACY POLICIES</h2>
        <p>
          Telos Swaps’s Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ...
          they shared and/or collect in Telos Swaps. This policy is not applicable
